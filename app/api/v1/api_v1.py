...
from app.api.v1.endpoints.admin_destinations import router as destination_router
from app.api.v1.endpoints.admin_categories import router as categories_router
from app.api.v1.endpoints.admin_tours import router as admin_tours_router
from app.api.v1.endpoints.admin_departures import router as admin_departures_router
from app.api.v1.endpoints.admin_guides import router as guide_router
...
from app.api.v1.endpoints.admin_bookings import router as temporary_booking
from app.api.v1.endpoints.guide_departures import router as guide_departures_router
